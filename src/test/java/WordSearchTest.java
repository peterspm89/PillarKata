...
class WordSearchTest {
    ...
    public void setUp() {
        ...
        /// I did make one change to add an 8th word ('KIRK')
        // for the diagonally descending backwards search.
        ...
        O,J,Y,E,U,L,N,C,C,L,Y,B,Z,R,H
        W,Z,M,I,S,U,K,U,R,B,I,D,I,X,S
    ...
    @DisplayName("10) Find words diagonally descending forwards.")
    @Test
    ...
    @DisplayName("11 Find words diagonally descending backwards.")
    @Test
